...
private:
	...
	enum LemmingAnims
	{
		WALKING_LEFT, WALKING_RIGHT, FALLING_LEFT, FALLING_RIGHT, DIGGING, FLOATER_INI_RIGHT, FLOATER_INI_LEFT, FLOATER_RIGHT, FLOATER_LEFT, CLIMBER_RIGHT, CLIMBER_LEFT, FALL_DIE, BLOCKER_ANIM, SAFE, SURRENDER, EXPLOSION, DIAG_BASHER_RIGHT, DIAG_BASHER_LEFT, BASHER_RIGHT, BASHER_LEFT
	};
