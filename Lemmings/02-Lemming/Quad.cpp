...
Quad *Quad::createQuad(float x, float y, float width, float height, ShaderProgramQuad &program)
{
...
Quad::Quad(float x, float y, float width, float height, ShaderProgramQuad &program)
{
